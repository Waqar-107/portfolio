...
exports.projects = [
  {
    name: 'ShashthoSheba',
    description: 'A telemedicine app for online consultation. The project is under the supervision of Prof. Dr. A.B.M Alim Al Islam(Razi) sir. I worked in the backend which is developed in Node.js and MongoDB. The app has been developed in Flutter.',
...

  {
    ...
    description: 'An webapp for the Centre for Energy Studies, BUET. The frontend is made using React js and the backend using Node.js and MongoDB. There\'s also an admin panel to update the data.',
...
exports.featuredProjects = [
...

  {
    imageName="Chess",
    name="ChessMaestro",
    description="A multiplayer chess game that i built as a project in my level 1, term 2 using java. For the GUI  javafx has been used.",
    tech:["java", "javaFX"],
    gitURL: "https://github.com/Waqar-107/ChessMaestro"
  },
